...
{/* Toggle Submit Button */}
              { togglesubmit ?  <i className="fa fa-plus add-btn" title="Add Items" onClick={addItems}></i>: 
                                <i className="fa  fa-edit add-btn" title="Update ItemsItems" onClick={addItems}></i>  
              };
